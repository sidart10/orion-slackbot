...
import { ingestSlackFile, ingestSlackFiles } from './ingestion.js';
...
describe('ingestSlackFile', () => {
  ...
  it('should successfully ingest a file', async () => {
    ...
    const { FilesApiClient } = await import('./api-client.js');
  ...
  it('should handle upload failure', async () => {
    const { downloadSlackFile } = await import('../slack/files/index.js');
    const { FilesApiClient, FilesApiError } = await import('./api-client.js');
