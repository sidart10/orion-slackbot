...
describe('skills/init', () => {
  ...
  describe('initializeSkills', () => {
    it('calls syncSkills on startup', async () => {
      ...
      const { initializeSkills, _resetForTests } = await import('./init.js');
      _resetForTests?.();
    ...
    it('sets skillsInitialized flag to true on success', async () => {
      ...
      // WHEN: Initializing skills
      const { initializeSkills, isSkillsInitialized, _resetForTests } = await import('./init.js');
      _resetForTests?.();
  ...
  describe('skillsInitialized flag', () => {
    ...
    it('returns false before initialization', async () => {
      ...
      const { isSkillsInitialized, _resetForTests } = await import('./init.js');
      _resetForTests?.();
