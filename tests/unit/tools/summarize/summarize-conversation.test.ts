...
import { summarizeConversation } from '@/tools/summarize/summarize-conversation.js';
...
vi.mock('@/tools/summarize/parse-time-range.js', () => ({
...
vi.mock('@/tools/summarize/parse-conversation-target.js', () => ({
...
describe('summarizeConversation', () => {
  ...
  describe('AC8: Error handling', () => {
    ...
    it('returns error for unresolved target', async () => {
      const { parseConversationTarget } = await import('@/tools/summarize/parse-conversation-target.js');
