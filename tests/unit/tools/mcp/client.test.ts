...
import type { McpClientConfig } from '@/tools/mcp/types.js';
import { SessionState } from '@/tools/mcp/types.js';
...
vi.mock('@/tools/mcp/gcp-auth.js', () => ({
  getGcpIdentityToken: vi.fn(),
}));

import { getGcpIdentityToken } from '@/tools/mcp/gcp-auth.js';
