...
describe('skills/loader', () => {
  ...
  describe('loadSkills', () => {
    it('returns empty array when .skills directory does not exist', async () => {
      ...
      const { loadSkills, _resetCacheForTests } = await import('@/skills/loader.js');
      _resetCacheForTests();
...
No proper fields`);
      ...
      const { loadSkillsWithResult, _resetCacheForTests } = await import('@/skills/loader.js');
      _resetCacheForTests();
...
Content`);
      ...
      const { getSkills, _resetCacheForTests } = await import('@/skills/loader.js');
      _resetCacheForTests();
...
Content`);
      ...
      const { getSkills, reloadSkills, _resetCacheForTests } = await import('@/skills/loader.js');
      _resetCacheForTests();
...
`;
  ...
  describe('loadSkillMetadata (metadata-only)', () => {
    it('returns empty array when .skills directory does not exist', async () => {
      ...
      const { loadSkillMetadata, _resetCacheForTests } = await import('@/skills/loader.js');
      _resetCacheForTests();
...
Content`);
      ...
      const { getSkillMetadata, _resetCacheForTests } = await import('@/skills/loader.js');
      _resetCacheForTests();
...
This is the full instruction content that should ONLY be loaded on-demand.`);
      ...
      const { loadSkillInstructions, _resetCacheForTests } = await import('@/skills/loader.js');
      _resetCacheForTests();
