...
describe('langfuse singleton', () => {
  ...
  it('should export healthCheck function', async () => {
    const { healthCheck } = await import('@/observability/langfuse.js');
    expect(healthCheck).toBeDefined();
    expect(typeof healthCheck).toBe('function');
  });

  it('should export shutdown function', async () => {
    const { shutdown } = await import('@/observability/langfuse.js');
  ...
  it('should throw error when credentials are missing in production (via environment validation)', async () => {
    ...
    await expect(import('@/observability/langfuse.js')).rejects.toThrow(
  ...
  it.skip('should call shutdownAsync on shutdown', async () => {
    ...
    const { getLangfuse, shutdown } = await import('@/observability/langfuse.js');
    getLangfuse();
    await shutdown();
  });
});
...
describe('getPrompt', () => {
  ...
  afterEach(async () => {
    const { _resetForTesting } = await import('@/observability/langfuse.js');
    _resetForTesting();
    vi.restoreAllMocks();
    vi.unstubAllEnvs();
  });
  ...
  it('should export getPrompt function', async () => {
    const { getPrompt } = await import('@/observability/langfuse.js');
  ...
  it('should throw error when Langfuse client not available for prompt fetching', async () => {
    const { getPrompt, _resetForTesting } = await import('@/observability/langfuse.js');
    _resetForTesting();
...
describe('logFeedbackScore', () => {
  ...
  it('should export logFeedbackScore function', async () => {
    const { logFeedbackScore } = await import('@/observability/langfuse.js');
  ...
  it('should return scored:true when traceId is provided (noop client)', async () => {
    const { logFeedbackScore, _resetForTesting } = await import('@/observability/langfuse.js');
    _resetForTesting();
