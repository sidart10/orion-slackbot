...
describe('Verification Metrics Module', () => {
  ...
  describe('trackVerification', () => {
    it('should increment totalAttempts on each call', async () => {
      const { trackVerification, getMetrics, resetMetrics } = await import('@/observability/metrics.js');
      resetMetrics();
    ...
    it('should log verification event', async () => {
      const { trackVerification, resetMetrics } = await import('@/observability/metrics.js');
      resetMetrics();
  ...
  describe('getMetrics', () => {
    it('should return current metrics state', async () => {
      const { getMetrics, resetMetrics } = await import('@/observability/metrics.js');
      resetMetrics();
...
describe('Citation Metrics Module', () => {
  ...
  describe('Module Exports', () => {
    it('should export CITATION_RATE_TARGET as 0.9', async () => {
      const { CITATION_RATE_TARGET } = await import('@/observability/metrics.js');
  ...
  describe('trackCitations', () => {
    ...
    it('should log citation metric event', async () => {
      const { trackCitations, resetCitationMetrics } = await import('@/observability/metrics.js');
      resetCitationMetrics();
  ...
  describe('getCitationMetrics', () => {
    it('should return current citation metrics state', async () => {
      const { getCitationMetrics, resetCitationMetrics } = await import('@/observability/metrics.js');
      resetCitationMetrics();
