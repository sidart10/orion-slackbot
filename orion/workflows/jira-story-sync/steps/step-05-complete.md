...
- 🎯 Focus ONLY on finalization and reporting
- 🚫 FORBIDDEN to execute any additional sync operations
- 💬 Generate complete, accurate report
- 🚪 This is the final step - end workflow gracefully

## EXECUTION PROTOCOLS:

- 🎯 Generate sync report markdown file
- 💾 Update sidecar state file
- 📖 Display completion summary
- 🚫 End workflow after completion
...
| Action | Count | Status |
|--------|-------|--------|
| Created | {created_count} | {created_success}/{created_count} ✅ |
| Updated | {updated_count} | {updated_success}/{updated_count} ✅ |
| Pulled | {pulled_count} | {pulled_success}/{pulled_count} ✅ |
...
|------|----------|--------|--------|
| `{filename}` | {jira_key} | {change_type} | ✅ Updated |
...
| Action | Result |
|--------|--------|
| ✅ Created | {created_success} stories |
| ✅ Updated | {updated_success} stories |
| ✅ Pulled | {pulled_success} stories |
| ⏭️ Skipped | {skipped_count} stories |
| ❌ Failed | {failed_count} stories |

## Files Updated

📄 **Sync Report:** `_bmad-output/sync-reports/jira-sync-{timestamp}.md`
📄 **Sync State:** `_bmad-output/jira-sync-state.yaml`
📄 **BMAD Stories:** {count} files updated with Jira keys

{If failures exist:}
⚠️ **{failed_count} operations failed.** Check the sync report for details.
